...
export default function Home() {
	return (
		<div className="">
					...
					<div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 md:ml-14 lg:grid-cols-3 gap-4 p-6">
						<div className="bg-white p-6 rounded-lg shadow-2xl">
							<div className="grid grid-cols-2 gap-10">
								...
								<div>
									<p className="text-dark-700 font-bold mt-12 text-3xl">200+</p>
								</div>
							</div>
						</div>
			...
			<aside id="main-content2" className="w-full overflow-x-scroll md:overflow-x-hidden tb lg:pl-14 md:pl-14 py-2 duration-1000">
						...
						<table className="w-full text-lg text-left rtl:text-right text-dark-500 shadow-2xl dark:text-dark-400 ">
							...
							<tbody>
								<tr className="bg-white border-b">
									...
									<td className="px-6 py-4">Kumala</td>
									<td className="px-6 py-4">Medan</td>
									<td className="px-6 py-4">50Kg</td>
